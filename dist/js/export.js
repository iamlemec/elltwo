...
import { BlobWriter, BlobReader } from '../node_modules/@zip.js/zip.js/lib/core/io.js';
import { ZipWriter } from '../node_modules/@zip.js/zip.js/lib/core/zip-writer.js';
...
async function createZip(blobs) {
    let bwrite = new BlobWriter('application/zip');
    let zwrite = new ZipWriter(bwrite);

    for (let [k, v] of blobs) {
        let r = new BlobReader(v);
...
export { createLatex, createMarkdown, exportLatex, exportMarkdown, initExport };
