import { MapMode, EditorSelection, EditorState, Transaction, Prec, StateEffect, Facet, ChangeSet, RangeSet, findColumn, Annotation, Text, codePointAt, codePointSize, combineConfig, RangeValue, findClusterBreak, CharCategory } from '../../state/dist/index.js';
...
export { BidiSpan, BlockInfo, BlockType, Decoration, Direction, EditorView, GutterMarker, RectangleMarker, ViewPlugin, ViewUpdate, WidgetType, drawSelection, gutterLineClass, gutters, keymap, layer, lineNumberMarkers, lineNumbers, logException };
