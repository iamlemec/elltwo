import { MapMode, EditorSelection, EditorState, Transaction, Prec, StateEffect, Facet, ChangeSet, RangeSet, findColumn, Annotation, Text, codePointAt, codePointSize, countColumn, combineConfig, RangeValue, findClusterBreak, CharCategory, RangeSetBuilder } from '../../state/dist/index.js';
...
export { BidiSpan, BlockInfo, BlockType, Decoration, Direction, EditorView, GutterMarker, MatchDecorator, RectangleMarker, ViewPlugin, ViewUpdate, WidgetType, drawSelection, gutterLineClass, gutters, highlightSpecialChars, keymap, layer, lineNumberMarkers, lineNumbers, logException };
